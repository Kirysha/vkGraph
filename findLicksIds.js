...
const asyncQuery = async (obj = []) => {
  ...
  for (let index = 0; index < obj.length; index++) {
    ...
    var config = {
      method: "get",
      url: `https://api.vk.com/method/likes.getList?access_token=${access_token}&v=5.131&domain=primorsknews_ru&count=${count}&item_id=${item_id}&owner_id=${owner_id}&type=post&filter=likes&extended=1`,
      headers: {},
    };
